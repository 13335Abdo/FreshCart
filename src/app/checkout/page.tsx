    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          {/* Right Column - Order Summary (محسن) */}
          <div className="lg:w-96 xl:w-104">
            <div className="sticky top-24">
              {/* Header */}
              <div className="bg-linear-to-r from-green-600 to-green-700 rounded-t-2xl p-5">
              ...
              {/* Body */}
              <div className="bg-white rounded-b-2xl shadow-lg border border-t-0 border-gray-100 overflow-hidden">
